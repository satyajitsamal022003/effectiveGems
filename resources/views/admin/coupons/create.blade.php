                                                        ...
                                                        <div class="col-xl-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label" for="subCategories">Sub
                                                                        Categories</label>
                                                                </div>
                                                                <div id="subCategories-container" class="variant-container"
                                                                    style="display: none;">
                                                                    <div class="form-group">
                                                                        <label for="">Search Sub Categories</label>
                                                                        <select class="form-control" id="subCategoriesList"
