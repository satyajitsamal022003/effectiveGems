                                                ...
                                                <div class="row">
                                                    <div class="col-xl-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control required" id="" placeholder="Product Name" name="productName" required value="{{old('productName')}}">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required" id="" name="categoryId" onchange="getSubCategory(this.value)" required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Price MRP" name="priceMRP" value="{{old('priceMRP')}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    <label>Price B2C</label>
                                                                    <input class="form-control required" placeholder="Price B2C" name="priceB2C" value="{{old('priceB2C')}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    <label>Price B2B</label>
                                                                    <input class="form-control" placeholder="Price B2B" name="priceB2B" value="{{old('priceB2B')}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="" name="certificationId">
                                                                ...
                                                                <option value="{{ $certification->id }}">{{ $certification->amount }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="productDesc1" class="form-control" placeholder="Description 1" value="{{old('productDesc1')}}"></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 2" name="productHeading2" value="{{old('productHeading2')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description 2</label>
                                                    <textarea id="description2" name="productDesc2" class="form-control" placeholder="Description 2" value="{{old('productDesc2')}}"></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 3" name="productHeading3" value="{{old('productHeading3')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description 3</label>
                                                    <textarea id="description3" name="productDesc3" class="form-control" placeholder="Description 3" value="{{old('productDesc3')}}"></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 4" name="productHeading4" value="{{old('productHeading4')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description 4</label>
                                                    <textarea id="description4" name="productDesc4" class="form-control" placeholder="Description 4" value="{{old('productDesc4')}}"></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 5" name="productHeading5" value="{{old('productHeading5')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description 5</label>
                                                    <textarea id="description5" name="productDesc5" class="form-control" placeholder="Description 5" value="{{old('productDesc5')}}"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
