            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.editproductdata', $product->id) }}" enctype="multipart/form-data">
                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control required" id="" placeholder="Product Name" name="productName" required value="{{ $product->productName }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Product Small Name (To show on the variant)</label>
                                                            <input class="form-control" id="" placeholder="Product Small Name" name="variantName" value="{{ $product->variantName }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Category </label>
                                                            <select class="form-control required" id="categoryId" name="categoryId" onchange="getSubCategory(this.value)" required >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="subCategoryData" value="{{ $product->subCategoryId }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input class="form-control" id="" placeholder="Sort Order All Product" name="sortOrder" value="{{ $product->sortOrder }}">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <input class="form-control" id="" placeholder="Sort Order Category" name="sortOrderSubCategory" value="{{ $product->sortOrderSubCategory }}">
                                                                </div>
                                                            </div>
                                                            <div class="row mt-3">
                                                                <div class="col-lg-6">
                                                                    <input class="form-control" id="" placeholder="Sort Order Sub Category" name="sortOrderCategory" value="{{ $product->sortOrderCategory }}">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <input class="form-control" id="" placeholder="Sort Order Popular" name="sortOrderPopular" value="{{ $product->sortOrderPopular }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control required" id="price_type" name="price_type" required>
                                                                    <option value="">--Select Price Per--</option>
                                                                    <option value="Gram" {{ "Gram" == $product->price_type ? 'selected' : '' }}> Gram</option>
                                                                    <option value="Kg" {{ "Kg" == $product->price_type ? 'selected' : '' }}> Kg</option>
                                                                    <option value="Ratti" {{ "Ratti" == $product->price_type ? 'selected' : '' }}> Ratti</option>
                                                                    <option value="Carat" {{ "Carat" == $product->price_type ? 'selected' : '' }}> Carat</option>
                                                                    <option value="Pcs" {{ "Pcs" == $product->price_type ? 'selected' : '' }}> Pcs</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Price MRP" name="priceMRP" value="{{ $product->priceMRP }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    <label>Price B2C</label>
                                                                    <input class="form-control required" placeholder="Price B2C" name="priceB2C" required value="{{ $product->priceB2C }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    <label>Price B2B</label>
                                                                    <input class="form-control" placeholder="Price B2B" name="priceB2B" value="{{ $product->priceB2B }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <label for="lower-product-range">Lower product range
                                                                  <i class="fa fa-info-circle" data-bs-toggle="tooltip" title="Enter the Higher product range First"></i>
                                                                </label>
                                                                <input type="number" class="form-control" id="min_product_qty" name="min_product_qty" value="{{ $product->min_product_qty }}" oninput="validateProductRange()">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label>Higher product range</label>
                                                                <input type="number" class="form-control" id="max_product_qty" name="max_product_qty" value="{{ $product->max_product_qty }}" oninput="validateProductRange()">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-2">
                                                            <div class="col-xl-12">
                                                                <label for="out_of_stock" class="flex items-center">
                                                                    <input id="out_of_stock" type="checkbox" class="form-checkbox" name="out_of_stock" value="1" {{ $product->out_of_stock == 1 ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="" name="certificationId">
                                                                ...
                                                                <option value="{{ $certification->id }}" {{ $certification->id == $product->certificationId ? 'selected' : '' }}>{{ $certification->amount }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="activationId">
                                                                ...
                                                                <option value="{{ $activation->id }}" {{ $activation->id == $product->activationId ? 'selected' : '' }}>{{ $activation->amount }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="" name="courierTypeId">
                                                                ...
                                                                <option value="{{ $courier->id }}" {{ $courier->id == $product->courierTypeId ? 'selected' : '' }}>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-4">
                                                                        <label for="add_variant" class="flex items-center">
                                                                            <input id="add_variant" type="checkbox" class="form-checkbox" name="is_variant" checked value="{{ $product->is_variant }}">
                                                                ...
                                                                <div id="variant-container" class="variant-container">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="productvariant" name="variant[]" multiple>
                                                                            @php
                                                                                $selectedVariants = json_decode($product->variant, true);
                                                                            @endphp
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control imgInp" name="icon" id="icon" type="file" accept="image/*">
                                                    <span style="color:red; font-style:italic;font-size:15px">Only JPG,png files are acceptable</span><br>
                                                </div>
                                                <div class="col-md-2">
                                                    <img id="icondata" class="preview" src="{{ asset($product->icon) }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-md-2">Image1</label>
                                                <div class="col-md-8">
                                                    <input class="form-control imgInp" name="image1" id="image1" type="file" accept="image/*">
                                                    <span style="color:red; font-style:italic;font-size:15px">Only JPG,png files are acceptable</span><br>
                                                </div>
                                                <div class="col-md-2">
                                                    <img id="image1data" class="preview" src="{{ asset($product->image1) }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label col-md-2">Image2</label>
                                                <div class="col-md-8">
                                                    <input class="form-control imgInp" name="image2" id="image2" type="file" accept="image/*">
                                                    <span style="color:red; font-style:italic;font-size:15px">Only JPG,png files are acceptable</span><br>
                                                </div>
                                                <div class="col-md-2">
                                                    <img id="image2data" class="preview" src="{{ asset($product->image2) }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <img id="image3data" class="preview" src="{{ asset($product->image3) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 2" name="productHeading2" value="{{ $product->productHeading2 }}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 3" name="productHeading3" value="{{ $product->productHeading3 }}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 4" name="productHeading4" value="{{ $product->productHeading4 }}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 5" name="productHeading5" value="{{ $product->productHeading5 }}">
                                                </div>
                                                <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(key, val) {
                        $('#subCategory').append("<option value='" + val.id + "' " + (val.id == selectedSubCategoryId ? 'selected' : '') + ">" + val.subCategoryName + "</option>");
                    });
                },
