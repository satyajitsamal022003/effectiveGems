...
@section('page-title', 'Activation-List')
@section('content')
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="panel-heading col-md-2">
                    <a href="{{route('admin.addactivation')}}" class="btn btn-block btn-primary">Add Activation</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                      ...
                                      <td class="center action">
                                        @if ($category->id != 1 && $category->id != 2)  <!-- Check if the category id is not 1 or 2 -->
                                            <a href="{{ route('admin.editactivation', $category->id) }}" class="btn btn-sm bg-success mr-2">
                                                <i class="fa-solid fa-pencil"></i>
                                            </a>
                                    
                                            <a class="btn btn-sm bg-danger mr-2" href="{{ route('admin.deleteactivation', $category->id) }}"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function toggleOnStatus(categoryId) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.activationstatus') }}",
                data: {
                    '_token': '{{ csrf_token() }}',
