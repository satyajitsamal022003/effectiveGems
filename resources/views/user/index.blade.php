        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="as_aboutimg text-right" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    <img src="{{url('/')}}/user/assets/images/planets-1.png" alt="image" class="img-responsive animate-up-down">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="as_whychoose_box-img">
                    <img src="{{url('/')}}/user/assets/images/2150771723.jpg" alt="image" class="animate-up-down">
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <ul class="as_choose_ul" style="background-image: url('{{url('/')}}/user/assets/images/bg-content-section-astro.png')">
                    <li>
                                    ...
                                    <div class="accordion-header" id="panelsStayOpen-headingOne">
                                        <h2 class="mb-0">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                data-bs-target="#panelsStayOpen-15" aria-expanded="true"
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="panelsStayOpen-headingOne">
                                        <h2 class="mb-0">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#panelsStayOpen-14" aria-expanded="true"
                                    ...
                                    <div id="panelsStayOpen-14" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            <p>Absolutely Yes! You can be 100% sure when you buy a gemstone or diamond
                                                ...
                                                guarantee the authenticity of every gemstone &amp; diamond merchandise.&nbsp;</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <div class="accordion-header" id="panelsStayOpen-headingOne">
                                        <h2 class="mb-0">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#panelsStayOpen-13" aria-expanded="true"
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="panelsStayOpen-headingOne">
                                        <h2 class="mb-0">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#panelsStayOpen-12" aria-expanded="true"
                                    ...
                                    <div id="panelsStayOpen-12" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            <p>No, it is not related to the purity of a gemstone. Carat only defines the
                                                Weight of a gemstone or diamond. It is often confused with the&nbsp;<em>Karat</em>&nbsp;of
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="panelsStayOpen-headingOne">
                                        <h2 class="mb-0">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#panelsStayOpen-11" aria-expanded="true"
                                    ...
                                    <div id="panelsStayOpen-11" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            <p>Carat is the standard unit of weight around the world in which a gemstone
                                                or diamond is measured. Carat originated from the Latin word &quot;Carratus&quot;
                                    ...
                                    <div id="panelsStayOpen-8" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <p>&gt;<strong>Origin:</strong>&nbsp;The origin of a gemstone also plays an
                                                important role many times. Few origins have a premium &quot;Brand Value&quot;
