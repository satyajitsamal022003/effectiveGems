                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 col-12">
                            <div class="file-input-container">
                                <input type="file" name="profile_img" class="sm-input-file" id="file" accept="image/*" />
                                <label class="for-sm-input-file" for="file"><i class="fas fa-upload"></i> Update Profile Picture</label>
